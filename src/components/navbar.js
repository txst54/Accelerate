        ...
        <div className="flex flex-col justify-center h-16 p-4 bg-white">
            <div className="flex flex-row justify-between">
                <div className="flex flex-row">
                    ...
                    <input className="p-4 text-slate-800 focus:border-0 focus:outline-none" placeholder="Search">
                    </input>
                </div>
                <div className="flex flex-row items-center">
                    <div className="font-semibold p-6 hover:cursor-pointer hover:text-slate-600 transition-all duration-200">
                        Support
                    </div>
                    <div className="font-semibold p-6 hover:cursor-pointer hover:text-slate-600 transition-all duration-200">
                        Settings
